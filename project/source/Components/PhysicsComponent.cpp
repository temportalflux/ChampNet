...
PhysicsData PhysicsData::operator*(float multiple) {
	PhysicsData data = PhysicsData(*this);
	data *= multiple;
	return data;
}

void PhysicsData::operator*=(float multiple) {
	//vel *= multiple;
	acc *= multiple;
	//rotVel *= multiple;
	rotAcc *= multiple;
...
PhysicsData PhysicsData::operator+(PhysicsData other) {
	PhysicsData data = PhysicsData(*this);
	data += other;
	return data;
}

void PhysicsData::operator+=(PhysicsData other) {
	vel += other.vel;
	acc += other.acc;
	rotVel += other.rotVel;
	rotAcc += other.rotAcc;
