...
{\em id} & the \hyperlink{class_game_state_a7c5acf663dc54a1d6de3254209b8fff2}{client\-I\-D} \\
\hline
\end{DoxyParams}


\subsection{Member Function Documentation}
\hypertarget{class_game_state_ad74bf5767b052d5b32805220ca0c1fab}{\index{Game\-State@{Game\-State}!add\-Player@{add\-Player}}
...
\item[{float}]{color\-B}
\end{DoxyParamCaption}
)}}\label{class_game_state_ad74bf5767b052d5b32805220ca0c1fab}
Add a player to the game state 
\begin{DoxyParams}{Parameters}
{\em client\-I\-D} & the client which owns the player \\
\hline
{\em player\-I\-D} & the unique I\-D of the player \\
\hline
{\em local\-I\-D} & the unique I\-D local to the client \\
\hline
{\em name} & the name of the player \\
\hline
{\em color\-R} & the red channel of the overlay color \\
\hline
{\em color\-G} & the green channel of the overlay color \\
\hline
{\em color\-B} & the blue channel of the overlay color \\
\hline
\end{DoxyParams}
...
\hypertarget{class_game_state_a733fa68895adba783b0b4b804f16906f}{\index{Game\-State@{Game\-State}!remove\-Player@{remove\-Player}}
\index{remove\-Player@{remove\-Player}!GameState@{Game\-State}}
\subsubsection[{remove\-Player}]{\setlength{\rightskip}{0pt plus 5cm}void Game\-State\-::remove\-Player (
\begin{DoxyParamCaption}
\item[{unsigned int}]{player\-I\-D}
\end{DoxyParamCaption}
)}}\label{class_game_state_a733fa68895adba783b0b4b804f16906f}
Remove a player from the game state 
\begin{DoxyParams}{Parameters}
{\em player\-I\-D} & the unique \hyperlink{class_game_state_1_1_player_acbd28d89e6eb8611aa66452ec31e9133}{Player\-::player\-I\-D} of the player \\
\hline
\end{DoxyParams}
...
\hypertarget{class_game_state_a291fcda337b1a25c21871fe338399c27}{\index{Game\-State@{Game\-State}!serialize\-For\-Client@{serialize\-For\-Client}}
...
\end{DoxyParamCaption}
)}}\label{class_game_state_a291fcda337b1a25c21871fe338399c27}
Serializes the game state into a byte\mbox{[}\mbox{]} 
\begin{DoxyParams}{Parameters}
{\em packet\-I\-D} & the packet I\-D to include \\
\hline
{\em client\-I\-D} & the client\-I\-D to emulate this packet as (replaces the game state \hyperlink{class_game_state_a7c5acf663dc54a1d6de3254209b8fff2}{Game\-State\-::client\-I\-D} with the value in the byte\mbox{[}\mbox{]}, but doesn't set the value in the local game state). \\
\hline
...
\hypertarget{class_game_state_a7c5acf663dc54a1d6de3254209b8fff2}{\index{Game\-State@{Game\-State}!client\-I\-D@{client\-I\-D}}
\index{client\-I\-D@{client\-I\-D}!GameState@{Game\-State}}
\subsubsection[{client\-I\-D}]{\setlength{\rightskip}{0pt plus 5cm}int Game\-State.\-client\-I\-D}}\label{class_game_state_a7c5acf663dc54a1d6de3254209b8fff2}


A unique identifier (across all peers in the network) of the client which controls this player 

The I\-D of the client this gamestate is in.\hypertarget{class_game_state_a8b1949523ac8e40776c0617666023d64}{\index{Game\-State@{Game\-State}!player\-Request@{player\-Request}}
